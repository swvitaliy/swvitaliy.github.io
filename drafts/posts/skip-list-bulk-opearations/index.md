...
Если нужно удалить диапазон `[low, high]`, можно поступить следующим образом. Во первых, можно найти элемент, 
...
// TODO Benchmarks results
// TODO Benchmarks graphics

1. [ ] Сравнение конкурентной и не конкурентной версий
