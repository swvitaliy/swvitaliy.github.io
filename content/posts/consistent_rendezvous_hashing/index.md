...
Для начала стоит рассмотреть консистентное кеширование. 
...
// TODO Картинка принцип работы randevous 
