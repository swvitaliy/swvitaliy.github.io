...
В consistent hashing вы можете распределить vnodes неравномерно так, чтобы на некоторые узлы нагрузка приходила больше, чем на остальные (горячие ключи). В randezvous так сделать нельзя.
