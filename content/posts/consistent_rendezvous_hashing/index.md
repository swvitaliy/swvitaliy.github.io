...
Использование алгоритма распределения **рандеву по взвешенным узлам** дает честный линейный рост времени поиска узла от количества этих узлов. Использование 

Использование алгоритма распределения **рандеву (не взвешенный)** дает примерно 3-х кратный рост времени поиска узла при увеличении количества узлов от 3 до 100. Это довольно существенный прирост. 
